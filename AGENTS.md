...
- Root AGENTS.md and module AGENTS.md files generated
...
graph TD
    ...
    click B "./src/api/AGENTS.md" "View API module docs"
    click C "./src/core/AGENTS.md" "View Core module docs"
    click D "./src/experience/AGENTS.md" "View Experience module docs"
    click E "./src/input/AGENTS.md" "View Input module docs"
    click F "./src/strategies/AGENTS.md" "View Strategies module docs"
    click G "./src/types/AGENTS.md" "View Types module docs"

    click F1 "./src/strategies/base/AGENTS.md" "View base strategies docs"
    click F2 "./src/strategies/denoise/AGENTS.md" "View denoise strategies docs"
    click F3 "./src/strategies/semantic/AGENTS.md" "View semantic strategies docs"
    click F4 "./src/strategies/output/AGENTS.md" "View output strategies docs"
```
...
- Refer to `C:/Users/17775/.Codex/rules/` for full skill set
